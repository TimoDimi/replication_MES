...
Symbol_list <-  c("JPM", "BAC", "C", "GS", "MS", "WFC", "BK", "STT", "^VIX", "^SPX", "^SP500-40")
Symbol_names <- c("JPM", "BAC", "C", "GS", "MS", "WFC", "BK", "STT", "VIX",  "SP500", "SPF")
...
saveRDS(data_Assets, file = "applications/data/data_Assets_RR.rds")
...
saveRDS(data_Symbols$VIX %>%
          ...
          rename(VIX=Close),
        file = "applications/data/data_VIX_RR.rds")
